...
namespace ThirdPersonCharacter.Pipeline.Presentation
{
    public sealed class CharacterAnimationPresentationRuntime : IDisposable
    {
        ...
        readonly List<ActionAnimationPlaybackLifecycleSnapshot>
            m_ActionSnapshots;
        readonly List<ActionMarkerPlaybackSnapshot>
            m_ActionMarkerPlaybackSnapshots;
        readonly List<ActionMarkerRelationSnapshot>
            m_ActionMarkerRelationSnapshots;
            ...
            bool ownsGraphClock)
        {
            ...
            m_ActionSnapshots =
                new List<ActionAnimationPlaybackLifecycleSnapshot>(
                    frameCapacity);
            m_ActionMarkerPlaybackSnapshots =
                new List<ActionMarkerPlaybackSnapshot>(frameCapacity);
            m_ActionMarkerRelationSnapshots =
                new List<ActionMarkerRelationSnapshot>(frameCapacity);
            m_ActionTimeSnapshots =
        ...
        public IReadOnlyList<ActionMarkerRelationSnapshot>
            ActionMarkerRelationSnapshots =>
                m_ActionMarkerRelationSnapshots;
        public IReadOnlyList<ActionMarkerPlaybackSnapshot>
            ActionMarkerPlaybackSnapshots =>
                m_ActionMarkerPlaybackSnapshots;
            ...
            try
            {
                ...
                using (ActionSamplingMarker.Auto())
                {
                    ...
                    m_ActionSampling.ProjectPresentationSamples(
                        ...
                        presentationDeltaSeconds);
                    m_ActionSampling.ResolveSlotMarkers(
                        transaction.SamplingTransaction,
                        m_SlotPlans);
                ...
                lifecycle)
        {
            ...
            for (int i = 0; i < lifecycle.Count; i++)
            {
                ...
                m_ActionSampling.RebaseReleasedMarkerSource(
                    transaction.SamplingTransaction,
                    snapshot.PlaybackId);
            }
        }
            ...
            AnimationPresentationFrameTransaction transaction)
        {
            ...
            m_ActionSampling.BuildCommittedMarkerSnapshots(
                transaction.MarkerPlaybackSnapshots,
                transaction.MarkerRelationSnapshots);
        ...
        void ClearCommittedStateSnapshots()
        {
            ...
            m_ActionMarkerPlaybackSnapshots.Clear();
            m_ActionMarkerRelationSnapshots.Clear();
        ...
        void ClearPublishedDiagnostics()
        {
            if (m_DebugView == null &&
                ...
                m_ActionMarkerPlaybackSnapshots.Count == 0 &&
                m_ActionMarkerRelationSnapshots.Count == 0 &&
