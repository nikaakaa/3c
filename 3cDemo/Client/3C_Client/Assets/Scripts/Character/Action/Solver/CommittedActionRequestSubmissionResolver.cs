...
{
    public readonly struct CommittedActionRequestSubmissionResolverInput
    {
        public CommittedActionRequestSubmissionResolverInput(
    ...
    public static class CommittedActionRequestSubmissionResolver
    {
        public static CharacterActionRequestSubmissionResult Resolve(in CommittedActionRequestSubmissionResolverInput input)
        {
