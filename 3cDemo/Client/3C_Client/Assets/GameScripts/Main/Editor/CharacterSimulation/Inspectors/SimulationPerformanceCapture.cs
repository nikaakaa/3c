...
namespace ThirdPersonCharacter.Editor.CharacterSimulation
{
    ...
    static class SimulationPerformanceCapture
    {
        ...
        static readonly string[] s_MarkerNames =
        {
            ...
            "ThirdPerson.Presentation.Animation.PoseGraph.IKGoal",
            "ThirdPerson.Presentation.Animation.PoseGraph.LinkedPose",
            "ThirdPerson.Presentation.Animation.PoseGraph.FinalIKFullBody",
