...
{
    public sealed class LocomotionFramePipeline
    {
        const float DirectionSqrEpsilon = 0.000001f;

        readonly BasicLocomotionPipeline motionPipeline = new BasicLocomotionPipeline();

        public LocomotionFramePrepareFacts ResolvePrepareFacts(in LocomotionFramePipelineInput input)
        {
        ...
        public bool TryPrepareDecisionFrame(
            in LocomotionFramePipelineInput input,
            ...
            out LocomotionFramePipelineResult result)
        {
            ...
            decisionFrame = new LocomotionDecisionFrame(
                ...
                facts,
                prepareFacts.FrameGait);
            result = LocomotionFramePipelineResult.Prepared(in decisionFrame, in runtimeState);
            return true;
        }
            ...
            out LocomotionFramePipelineResult result)
        {
            ...
            BasicMovementPhase phaseBeforeTick = runner.Snapshot.LocomotionPhase;
            ...
            result = LocomotionFramePipelineResult.Evaluated(in stateDecision, in runtimeState);
            return true;
        }
            ...
            out LocomotionFramePipelineResult result)
        {
            ...
            CharacterRuntimeLocomotionFacts locomotionFacts = new CharacterRuntimeLocomotionFacts(
                ...
                currentStep);
            result = LocomotionFramePipelineResult.Built(
                in stateDecision,
                in frame,
                in motionFacts,
                in locomotionFacts,
