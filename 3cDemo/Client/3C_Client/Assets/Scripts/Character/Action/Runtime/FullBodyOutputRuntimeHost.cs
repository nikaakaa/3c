...
{
    internal sealed class FullBodyOutputRuntimeHost :
    ...
    {
        readonly FullBodyActionRuntimeModule module;
        readonly IFullBodyActionRuntimeUnityAdapter unityAdapter;

        public FullBodyOutputRuntimeHost(
            FullBodyActionRuntimeModule module,
        ...
        {
            get => module.StateMachineRuntime.DebugFullBodyStatePath;
            set => module.StateMachineRuntime.DebugFullBodyStatePath = value;
        }
        ...
        {
            get => module.StateMachineRuntime.LastLoggedFullBodyPath;
            set => module.StateMachineRuntime.LastLoggedFullBodyPath = value;
        }
