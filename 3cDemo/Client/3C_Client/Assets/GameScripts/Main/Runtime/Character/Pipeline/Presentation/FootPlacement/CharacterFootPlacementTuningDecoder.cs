    ...
    internal static class CharacterFootPlacementTuningDecoder
    {
            ...
            CharacterPoseTuningParameterBlock block)
        {
            ...
            try
            {
                ...
                float minimumLegExtensionRatio = stance.MinimumLegExtensionRatio;
                float maximumLegExtensionRatio = stance.MaximumLegExtensionRatio;
                ...
                for (int i = 0; i < layout.Entries.Count; i++)
                {
                    ...
                    else if (fieldId.EndsWith("/stance-stabilization/minimum-leg-extension-ratio", StringComparison.Ordinal)) minimumLegExtensionRatio = value.FloatValue;
                    else if (fieldId.EndsWith("/stance-stabilization/maximum-leg-extension-ratio", StringComparison.Ordinal)) maximumLegExtensionRatio = value.FloatValue;
