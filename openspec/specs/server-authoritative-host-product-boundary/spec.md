# server-authoritative-host-product-boundary Specification

## Purpose

定义 Unity Authority 与 DotRecast Authority 各自独立的 Fantasy Server 产品入口、模块闭包、配置、路由适配、构建 manifest 和运行边界。
