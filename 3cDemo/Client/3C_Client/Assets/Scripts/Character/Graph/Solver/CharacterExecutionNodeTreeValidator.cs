...
{
    public sealed class CharacterExecutionNodeTreeValidationResult
    {
    ...
    public static class CharacterExecutionNodeTreeValidator
    {
        public static CharacterExecutionNodeTreeValidationResult Validate(CharacterExecutionNodeTree tree)
        {
            CharacterExecutionNodeTreeValidationResult result = new CharacterExecutionNodeTreeValidationResult();
