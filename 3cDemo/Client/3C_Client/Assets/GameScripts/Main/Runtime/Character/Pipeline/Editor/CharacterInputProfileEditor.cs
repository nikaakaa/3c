...
namespace ThirdPersonCharacter.Pipeline.Editor
{
    ...
    public sealed class CharacterInputProfileEditor : UnityEditor.Editor
    {
        ...
        SerializedProperty m_InputHistoryCapacity;
        ...
        void OnEnable()
        {
            ...
            m_InputHistoryCapacity = serializedObject.FindProperty("m_InputHistoryCapacity");
        ...
        public override void OnInspectorGUI()
        {
            ...
            EditorGUILayout.PropertyField(m_InputHistoryCapacity);
