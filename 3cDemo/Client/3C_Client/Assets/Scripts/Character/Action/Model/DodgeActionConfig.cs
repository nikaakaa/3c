...
{
    [Serializable]
    public readonly struct DodgeActionConfig
    {
        public DodgeActionConfig(float duration, float distance, int priority, int resistance, bool rotateToDirection)
            : this(duration, distance, duration, distance, priority, resistance, rotateToDirection, false)
        {
        }

        public DodgeActionConfig(
        ...
        public static DodgeActionConfig Default => new DodgeActionConfig(0.35f, 4f, 0.35f, 3f, 30, 20, true, false);
    }
}
