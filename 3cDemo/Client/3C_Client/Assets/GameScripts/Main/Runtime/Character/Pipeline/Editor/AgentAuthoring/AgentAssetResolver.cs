...
namespace ThirdPersonCharacter.Pipeline.Editor.AgentAuthoring
{
    public sealed class AgentAssetResolver
    {
        ...
        public bool TryResolveTimelineAsset(AgentPatchOperation operation, out TimelineAsset timelineAsset)
        {
            timelineAsset = null;
            UnityEngine.Object asset = ResolveObject(operation.timelineAssetGuid, operation.timelineAssetPath, typeof(TimelineAsset));
            ...
            return TryResolveTimelineFromSnapshot(operation.timeline, out timelineAsset);
        }

        public bool TryResolveActionContext(AgentPatchOperation operation, out ActionContextSlot actionContext)
        {
            actionContext = null;
            UnityEngine.Object asset = ResolveObject(operation.actionContextAssetGuid, operation.actionContextAssetPath, typeof(ActionContextSlot));
            ...
            return TryResolveActionContextFromSnapshot(operation.actionContext, out actionContext);
        }
