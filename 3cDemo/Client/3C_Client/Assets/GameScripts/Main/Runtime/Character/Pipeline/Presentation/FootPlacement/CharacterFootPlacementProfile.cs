...
namespace ThirdPersonCharacter.Pipeline.Presentation
{
    ...
    public sealed class CharacterFootMotionAuthoringSettings
    {
        ...
        [SerializeField] float m_SwingVerticalCorrectionMaximumSpeed;
        ...
        internal CharacterFootMotionSettings Build() =>
            new CharacterFootMotionSettings(
                ...
                m_SwingVerticalCorrectionMaximumSpeed,
                m_LockDistance,
                m_SlideDistance,
    ...
    internal readonly struct CharacterFootMotionSettings
    {
        ...
        internal void RequireValid()
        {
            if (!float.IsFinite(LandingAcceptanceDistance) ||
                ...
                !float.IsFinite(SwingVerticalCorrectionMaximumSpeed) ||
                SwingVerticalCorrectionMaximumSpeed <= 0f ||
    ...
    {
        public const string SchemaVersion = "character-foot-placement-profile/v29-swing-vertical-rate";
