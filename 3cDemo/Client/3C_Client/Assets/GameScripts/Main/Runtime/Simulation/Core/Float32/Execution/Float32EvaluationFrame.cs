...
namespace ThirdPersonSimulation
{
    ...
    internal sealed class Float32EvaluationFrame
    {
        ...
        internal void RestoreOutput(Float32EvaluationOutputSavepoint savepoint)
        {
            ...
            {
                throw new InvalidOperationException("Float32 evaluation output savepoint is invalid.");
            }
