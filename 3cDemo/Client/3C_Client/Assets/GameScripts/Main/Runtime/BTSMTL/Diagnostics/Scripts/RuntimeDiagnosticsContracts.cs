...
namespace BTSMTL.Diagnostics
{
    ...
    public struct RuntimeFootIkLegTraceSnapshot
    {
        ...
        public ulong PlanAttemptRequestSourceSampleIdentity;
        public int PlanAttemptRequestSourceSampleCycle;
        public int PlanAttemptRequestEventOrdinal;
        public float PlanAttemptRequestEventPhase;
        public float PlanAttemptRequestTimeToLandingSeconds;
        public ulong PlanAttemptRequestMotionGeneration;
        public ulong PlanAttemptRequestMotionAuthorityTick;
        public Vector2 PlanAttemptRequestMotionCurrentVelocity;
        public Vector2 PlanAttemptRequestMotionContinuationVelocity;
        public float PlanAttemptRequestMotionYawVelocityDegreesPerSecond;
        public Vector3 PlanAttemptRequestRootStart;
        public Quaternion PlanAttemptRequestRootStartRotation;
        public Vector3 PlanAttemptRequestPresentedBodyStartPosition;
        public Vector3 PlanAttemptRequestCommittedBodyVelocity;
        public float PlanAttemptRequestTrajectoryCurvatureDegreesPerSecond;
        public bool PlanAttemptRequestTrajectoryCurvatureAvailable;
        public double PlanAttemptRequestMovementPlaybackTime;
        public Vector3 PlanAttemptRequestUp;
        public float PlanAttemptRequestSoleSupportRadius;
        public float PlanAttemptRequestLegLength;
        public string PlanBuildCandidateKind;
        public string PlanBuildDecisionReason;
        public ulong PlanBuildLandingEventIdentity;
        public string PlanBuildOriginKind;
        public ulong PlanBuildOriginPlanSequence;
        public ulong PlanBuildOriginLandingEventIdentity;
        public int PlanBuildOriginSupportSurfaceIdentity;
        public ulong PlanBuildMotionGeneration;
        public ulong PlanBuildMotionAuthorityTick;
        public bool PlanBuildAttempted;
        public bool PlanBuildCurrentPlanningCandidate;
        public bool PlanBuildIncomingPlanningCandidate;
        public bool PlanBuildCurrentPlanMatches;
        public bool PlanBuildActiveEventReplaced;
        public bool PlanBuildNeedsInitialPlan;
        public bool PlanBuildIntentRevisionRequested;
        public bool PlanBuildCanPrepareEventSuccessor;
        public bool PlanBuildMotionWithinCommitTolerance;
        public bool PlanBuildCanBeginTransition;
        public bool PlanBuildFutureBodyAvailable;
        public bool PlanBuildCurrentPlanHasExecutablePath;
        public bool PlanBuildPlanFadingOut;
