        ...
        internal static readonly CharacterFootCsvGroup<Source, Record> Schema =
            new CharacterFootCsvGroup<Source, Record>(
                "Sample", () => new Record(), new Column[]
                {
                    ...
                    Column.Compose(CharacterFootPathContinuityColumns.Schema, (in Source source) => source.Motion, (target, value) => target.PathContinuity = value),
                    Column.Compose(CharacterFootLifecycleColumns.Schema, (in Source source) => source.Motion, (target, value) => target.Lifecycle = value),
                    Column.Compose(CharacterFootOutputStagesColumns.Schema, (in Source source) => source.Motion, (target, value) => target.OutputStages = value),
                    ...
                    Column.Compose(CharacterFootResponseColumns.Schema, (in Source source) => source.Motion, (target, value) => target.Response = value),
