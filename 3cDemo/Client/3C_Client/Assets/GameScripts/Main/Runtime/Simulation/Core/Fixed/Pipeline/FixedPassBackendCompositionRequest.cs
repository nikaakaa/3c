...
namespace ThirdPersonSimulation.Fixed
{
    ...
    public sealed class FixedPassBackendCompositionRequest
    {
        ...
        public FixedPassBackendCompositionRequest(
        ...
        void Validate()
        {
            ...
            if (!profile.Id.Equals(Descriptor.NumericProfileId) ||
                ...
                profile != FixedSimulationNumericProfile.Value)
            {
                throw Failure("Fixed_program_runtime_mismatch", "ProgramCatalog does not match the locked Fixed Program Runtime identity.");
            }
