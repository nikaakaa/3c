...
{
    public interface IFloat32CompiledPipelinePassRuntime : ICompiledSimulationPipelinePassRuntime
    {
    }

    public abstract class Float32PipelinePassRuntimeBase : ISimulationPipelinePassRuntime
    {
        readonly SimulationPipelinePassLifecycleController m_Lifecycle = new SimulationPipelinePassLifecycleController();

        protected Float32PipelinePassRuntimeBase(SimulationPipelinePassDescriptor descriptor)
        {
    ...
    public sealed class Float32IngressPassRuntimeAdapter<TReadPorts, TWritePorts> : IFloat32CompiledPipelinePassRuntime
        ...
        where TWritePorts : ISimulationPipelineWritePortSet
    {
        ...
        public Float32IngressPassRuntimeAdapter(
    ...
    public sealed class Float32SchedulePassRuntimeAdapter<TReadPorts, TWritePorts> : IFloat32CompiledPipelinePassRuntime
        where TReadPorts : ISimulationPipelineReadPortSet
        where TWritePorts : ISimulationPipelineWritePortSet
    {
        ...
        public Float32SchedulePassRuntimeAdapter(
    ...
    public sealed class Float32StepPassRuntimeAdapter<TReadPorts, TWritePorts> : IFloat32CompiledPipelinePassRuntime
        where TReadPorts : ISimulationPipelineReadPortSet
        where TWritePorts : ISimulationPipelineWritePortSet
    {
        ...
        public Float32StepPassRuntimeAdapter(
    ...
    public sealed class Float32EgressPassRuntimeAdapter<TReadPorts, TWritePorts> : IFloat32CompiledPipelinePassRuntime
        where TReadPorts : ISimulationPipelineReadPortSet
        where TWritePorts : ISimulationPipelineWritePortSet
    {
        ...
        public Float32EgressPassRuntimeAdapter(
    ...
    public interface IFloat32PipelinePassRuntimeFactory
    {
        SimulationPipelinePassFactoryDescriptor Descriptor { get; }
        IFloat32CompiledPipelinePassRuntime Create(Float32PipelinePassRuntimeFactoryContext context);
    }

    public sealed class Float32PipelinePassRuntimeFactoryContext
    {
        ...
        internal Float32PipelinePassRuntimeFactoryContext(
        ...
        public Float32PipelineProductPortBinder Products { get; }
    ...
    public sealed class Float32PipelinePassRuntimeFactoryCatalog
    {
        readonly ReadOnlyCollection<IFloat32PipelinePassRuntimeFactory> m_Factories;

        public Float32PipelinePassRuntimeFactoryCatalog(IEnumerable<IFloat32PipelinePassRuntimeFactory> factories)
        {
            var values = factories == null
                ? new List<IFloat32PipelinePassRuntimeFactory>()
                : new List<IFloat32PipelinePassRuntimeFactory>(factories);
        ...
        public IReadOnlyList<IFloat32PipelinePassRuntimeFactory> Factories => m_Factories;

        public IFloat32PipelinePassRuntimeFactory GetRequired(CompiledSimulationPipelinePass pass)
        {
            for (int i = 0; i < m_Factories.Count; i++)
            {
                IFloat32PipelinePassRuntimeFactory factory = m_Factories[i];
                if (!SameIdentity(factory.Descriptor, pass.Factory))
                    continue;
                RequireDescriptorMatch(factory.Descriptor, pass.Factory);
                return factory;
            }
            throw new KeyNotFoundException($"Float32 runtime factory '{pass.Descriptor.PassId}@{pass.Descriptor.ImplementationVersion}' is not installed.");
        }
            ...
            SimulationPipelinePassFactoryDescriptor expected)
        {
            ...
            {
                throw new InvalidOperationException($"Float32 runtime factory '{expected.Identity.PassId}' descriptor does not match the compiled plan.");
            }
        }
    }
}
