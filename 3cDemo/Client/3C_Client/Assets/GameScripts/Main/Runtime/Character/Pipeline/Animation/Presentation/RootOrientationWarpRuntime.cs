...
namespace ThirdPersonCharacter.Pipeline.Animation.Presentation
{
    internal sealed class RootOrientationWarpRuntime
    {
        ...
        readonly AnimationSequencePlayerRuntime m_Sequence;
        ...
        internal RootOrientationWarpRuntime(
            ...
            AnimationSequencePlayerRuntime sequence)
        {
            ...
            if (descriptor.SequencePlayerIndex < 0 ||
                Math.Abs(descriptor.Duration - sequence.Duration) > 0.0001f)
            {
                throw new InvalidOperationException(
                    $"Root Orientation Warp '{descriptor.NodeId}' does not match its Sequence Player.");
            }
