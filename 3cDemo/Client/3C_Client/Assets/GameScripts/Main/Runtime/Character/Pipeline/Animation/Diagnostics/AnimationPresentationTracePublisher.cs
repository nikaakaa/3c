    ...
    internal static class AnimationPresentationTracePublisher
    {
            ...
            Vector3 poseRootWorldScale)
        {
            ...
            return new RuntimeFootIkLegTraceSnapshot
            {
                ...
                StanceOwnershipState = grounding.StanceOwnershipState.ToString(),
                AnchorTransactionState = grounding.AnchorTransactionState.ToString(),
                AnchorPlanSequence = grounding.AnchorPlanSequence,
                AnchorLandingEventIdentity = grounding.AnchorLandingEventIdentity,
                AnimationConstraintEventIdentity = grounding.AnimationConstraintEventIdentity,
                AnimationConstraintWeight = grounding.AnimationConstraintWeight,
                AnimationSupportWeight = grounding.AnimationSupportWeight,
                RawAnchorBlendWeight = grounding.RawAnchorBlendWeight,
                AnchorBlendTarget = grounding.AnchorBlendTarget,
                RawPelvisSupportWeight = grounding.RawPelvisSupportWeight,
                PelvisSupportTarget = grounding.PelvisSupportTarget,
                CommittedAnchorGoalAvailable = grounding.CommittedAnchorGoalAvailable,
