...
namespace ThirdPersonAction
{
    ...
    public readonly struct CharacterActionRequestSubmissionResult
    {
        ...
        public CharacterActionRequestSubmissionResult(
            ...
            : this(request, decision, requestSubmissions, default)
        {
        }
        ...
        public bool HasResolvedAction => Accepted && ResolvedAction.HasResolvedAction;
    }
    ...
    public static class CharacterActionRequestSubmissionArbiter
    {
        ...
        public static CharacterActionRequestSubmissionResult Evaluate(
            in CharacterActionRequestSubmissionInput input,
            IReadOnlyList<ICharacterFrameRequestSubmissionProvider> providers)
        {
            ...
            CharacterResolvedAction selectedResolvedAction = default;
            int providerCount = providers != null ? providers.Count : 0;
            ...
            for (int i = 0; i < providerCount; i++)
            {
                ...
                if (!hasSelected || IsHigherPriority(in candidate, in selectedCandidate))
                {
                    ...
                    selectedResolvedAction = candidate.ResolvedAction;
                    hasSelected = true;
                }
            }
            ...
            CharacterFrameRequestSubmissionSet submissions = new CharacterFrameRequestSubmissionSet(
                ...
                fourthSubmission,
                submissionCount);
            return new CharacterActionRequestSubmissionResult(
                selectedRequest,
                selectedDecision,
                submissions,
                selectedResolvedAction);
        }
