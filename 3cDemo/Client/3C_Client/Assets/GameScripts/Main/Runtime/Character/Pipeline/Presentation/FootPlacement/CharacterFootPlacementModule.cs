    ...
    internal sealed class CharacterFootPlacementModule : IDisposable
    {
            ...
            CharacterFootPlacementBank bank)
        {
            ...
            bool leftFormalFootHeightAvailable = formalFrameAvailable &&
                ...
                formalFootFrame.ContributionContinuityIdentity ==
                leftSelectedStep.ContributionContinuityIdentity &&
                formalFootFrame.Cycle == leftSelectedStep.SourceSampleCycle;
            bool rightFormalFootHeightAvailable = formalFrameAvailable &&
                rightSelectedStep.IsValid &&
                formalFootFrame.ContributionContinuityIdentity ==
                rightSelectedStep.ContributionContinuityIdentity &&
                formalFootFrame.Cycle == rightSelectedStep.SourceSampleCycle;
