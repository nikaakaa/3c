...
- [ ] 6.34 用带Frame/Completion/Side/WorldSole与Goal权重的唯一Committed Weighted Goal Sole参考替换旧Visible松散字段，修正把Pending开放标志当历史有效性的读取门；不修改SealFrame事务语义，不把Goal参考叫作Final Physical Sole
