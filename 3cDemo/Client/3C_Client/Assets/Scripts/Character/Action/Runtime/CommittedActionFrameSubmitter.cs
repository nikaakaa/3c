...
{
    public sealed class CommittedActionFrameSubmitter : ICharacterFrameRequestSubmitter, ICharacterFrameOutputSubmitter
    {
            ...
            out string failureReason)
        {
            ...
            CharacterFrameCandidateOutput locomotionCandidate = CharacterFrameCandidateOutput.Locomotion(
                ...
                sourceStep);
            CharacterFrameCandidateOutput actionCandidate = CharacterFrameCandidateOutput.CommittedAction(
                actionMotionResult.HasActionMovement,
                actionLifecycle.HasAnimationRequest,
                sourceStep);
            ...
            int step)
        {
            ...
            return new CharacterFrameActionOutputSubmission(
                ...
                actionLifecycle.ExitedThisFrame,
                step,
                actionLifecycle.CommittedActionBranchOutcome);
        }
            ...
            int sourceStep)
        {
            ...
            return LocomotionPreemptionFact.CommittedActionStarted(
