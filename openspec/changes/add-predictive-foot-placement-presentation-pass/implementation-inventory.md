...
- Corin 正式角色资产：`Assets/Prefabs/可琳.prefab`。VisualRoot 为 Animancer Animator transform；Host 显式绑定 Animancer、WorldBodyBinding、VisualRoot、Body Profile 与 Camera。
...
- `Assets/Prefabs/可琳.prefab`及正式网络/回滚角色装配上的唯一Rig、左右LimbIK、Final IK adapter与Composition
