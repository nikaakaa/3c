            ...
            new CharacterFootCsvGroup<Source, CharacterFootMotionCoreSample>(
                "MotionCore", () => new CharacterFootMotionCoreSample(), new Column[]
                {
                    Column.Create("FootMotionState", Codecs.Text, Unit.Category,
                        (in Source source) => source.Motion.State.ToString(), (target, value) => target.State = value),
                    Column.Create("FootMotionRejectReason", Codecs.Text, Unit.Category,
                        (in Source source) => source.Motion.RejectReason.ToString(), (target, value) => target.RejectReason = value),
                    Column.Create("FootMotionLandingEventIdentity", Codecs.UInt64, Unit.Identity,
                        (in Source source) => source.Motion.LandingEventIdentity, (target, value) => target.LandingEventIdentity = value),
                    Column.Create("FootMotionGroundPathInputIdentity", Codecs.UInt64, Unit.Identity,
                        (in Source source) => source.Motion.GroundPathInputIdentity, (target, value) => target.GroundPathInputIdentity = value),
                    Column.Create("FootMotionDistance", Codecs.Float32, Unit.Metres,
                        (in Source source) => source.Motion.Distance, (target, value) => target.Distance = value),
                    Column.Create("FootMotionProgress", Codecs.Float32, Unit.Unitless,
                        (in Source source) => source.Motion.Progress, (target, value) => target.SwingProgress = value),
                    Column.Create("FootMotionOriginalSole", Codecs.Vector, Unit.Metres,
                        (in Source source) => source.Motion.OriginalSole, (target, value) => target.OriginalSole = value),
                    Column.Create("FootMotionOriginalAnkle", Codecs.Vector, Unit.Metres,
                        (in Source source) => source.Motion.OriginalAnkle, (target, value) => target.OriginalAnkle = value),
                    ...
                    Column.Create("FootMotionBaselineSample", Codecs.Vector, Unit.Metres,
                        (in Source source) => source.Motion.BaselineSample, (target, value) => target.SwingBaselineSample = value),
                    ...
                    Column.Create("FootMotionEnvelopeSample", Codecs.Vector, Unit.Metres,
                        (in Source source) => source.Motion.EnvelopeSample, (target, value) => target.SwingEnvelopeSample = value),
                    ...
                    Column.Create("FootMotionLandingPredictionError", Codecs.Float32, Unit.Metres,
                        (in Source source) => source.Motion.LandingPredictionError, (target, value) => target.LandingPredictionError = value),
                    Column.Create("FootMotionCorrectedSole", Codecs.Vector, Unit.Metres,
                        (in Source source) => source.Motion.CorrectedSole, (target, value) => target.CorrectedSole = value),
                    Column.Create("FootMotionCorrectedAnkle", Codecs.Vector, Unit.Metres,
                        (in Source source) => source.Motion.CorrectedAnkle, (target, value) => target.CorrectedAnkle = value),
                    Column.Create("FootMotionPositionWeight", Codecs.Float32, Unit.Unitless,
                        (in Source source) => source.Motion.PositionWeight, (target, value) => target.MotionPositionWeight = value),
                    Column.Create("FootMotionRotationWeight", Codecs.Float32, Unit.Unitless,
                        (in Source source) => source.Motion.RotationWeight, (target, value) => target.MotionRotationWeight = value),
                    Column.Create("FootMotionConstraintState", Codecs.Text, Unit.Category,
                        (in Source source) => source.Motion.ConstraintState.ToString(), (target, value) => target.ConstraintState = value),
                    Column.Create("FootMotionLockResponse", Codecs.Text, Unit.Category,
                        (in Source source) => source.Motion.LockResponse.ToString(), (target, value) => target.LockResponse = value),
                    Column.Create("FootMotionSupportHorizontalError", Codecs.Float32, Unit.Metres,
                        (in Source source) => source.Motion.SupportHorizontalError, (target, value) => target.SupportHorizontalError = value),
                    Column.Create("FootMotionContactOwnership", Codecs.Float32, Unit.Unitless,
                        (in Source source) => source.Motion.ContactOwnership, (target, value) => target.ContactOwnership = value),
                    Column.Create("FootMotionSupportWeight", Codecs.Float32, Unit.Unitless,
                        (in Source source) => source.Motion.SupportWeight, (target, value) => target.SupportWeight = value),
                    Column.Create("FootMotionLandingReachEvaluated", Codecs.Boolean, Unit.None,
                        (in Source source) => source.Motion.LandingReachEvaluated, (target, value) => target.LandingReachEvaluated = value),
                    Column.Create("FootMotionLandingReachAvailable", Codecs.Boolean, Unit.None,
                        (in Source source) => source.Motion.LandingReachAvailable, (target, value) => target.LandingReachAvailable = value),
                    Column.Create("FootMotionSupportContactAnchor", Codecs.Vector, Unit.Metres,
                        (in Source source) => source.Motion.SupportContactAnchor, (target, value) => target.Anchor = value),
                    Column.Create("FootMotionContactPlaneAvailable", Codecs.Boolean, Unit.None,
                        (in Source source) => source.Motion.ContactPlaneAvailable, (target, value) => target.ContactPlaneAvailable = value),
                    Column.Create("FootMotionContactSurfaceIdentity", Codecs.Int32, Unit.Identity,
                        (in Source source) => source.Motion.ContactSurfaceIdentity, (target, value) => target.ContactSurfaceIdentity = value, "FootMotionContactPlaneAvailable"),
                    Column.Create("FootMotionContactPlaneNormal", Codecs.Vector, Unit.Direction,
                        (in Source source) => source.Motion.ContactPlaneNormal, (target, value) => target.ContactNormal = value, "FootMotionContactPlaneAvailable"),
                    ...
                    Column.Create("FootMotionDesiredCorrection", Codecs.Vector, Unit.Metres,
                        (in Source source) => source.Motion.DesiredCorrection, (target, value) => target.SwingDesiredCorrection = value),
                });
    }
}
