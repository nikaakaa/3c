...
namespace MCPForUnity.Editor.Tools
{
    ...
    public class McpForUnityToolAttribute : Attribute
    {
        ...
        /// <summary>
        /// Allows the declared polling status action to execute on the transport thread.
        /// The status handler must not access Unity APIs and must synchronize its own state.
        /// </summary>
        public bool BackgroundPollingStatus { get; set; } = false;
        ...
        public bool HasBehaviorAnnotations { get; set; } = false;
