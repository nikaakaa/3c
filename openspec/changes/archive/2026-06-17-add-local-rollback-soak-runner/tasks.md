...
- [x] 2.6 运行最新版 `LocalRollbackSynctestFoundationTests` Unity Test Runner。
- [x] 2.7 运行相关 full-body rollback replay Unity Test Runner。

## 3. Validation
- [x] 3.1 运行 `openspec validate add-local-rollback-soak-runner --strict --no-interactive`。
- [x] 3.2 Unity Editor 当前会话 Console 检查 0 个编译错误。
