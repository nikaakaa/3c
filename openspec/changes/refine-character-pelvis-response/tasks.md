...
- [ ] 11.2 在共享编辑器无占用时，仅试验Corin正式MinimumLandingLegCompressionReserve从20到10毫米，显式刷新并顺序重建匹配Float32/Fixed产品，不改Foot目标、Bend、3Hz和其它参数
- [ ] 11.3 同Record完成正式Replay与原诊断封口，核对正式余量、输入/Proof身份、平地/台阶骨盆及全部Foot/Knee质量；模型不替代运行验收
- [ ] 11.4 按实际收益及明确回归保留或精确撤销，保存候选和必要恢复原包/Proof/独立提交，193957固定效果对照不替换
