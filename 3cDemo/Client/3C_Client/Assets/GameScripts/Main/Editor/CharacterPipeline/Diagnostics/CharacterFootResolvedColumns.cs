        ...
        static CharacterFootCsvGroup<Source, CharacterFootResolvedSample> Create()
        {
            var columns = new System.Collections.Generic.List<Column>
            {
                Column.Create("ResolvedFrameSequence", Codecs.UInt64, Unit.Frame,
                    (in Source source) => source.Core.FrameSequence, (target, value) => target.Frame = value),
                Column.Create("ResolvedCompletionIdentity", Codecs.UInt64, Unit.Identity,
                    (in Source source) => source.Core.CompletionIdentity, (target, value) => target.Completion = value),
                Column.Create("ResolvedRigId", Codecs.Text, Unit.Identity,
                    (in Source source) => source.Core.RigId, (target, value) => target.RigId = value),
                Column.Create("ResolvedRigRevision", Codecs.Text, Unit.Identity,
                    (in Source source) => source.Core.RigRevision, (target, value) => target.RigRevision = value),
                Column.Create("ResolvedSide", Codecs.Text, Unit.Category,
                    (in Source source) => source.Core.Side.ToString(), (target, value) => target.Side = value),
                Column.Create("ResolvedOutcome", Codecs.Text, Unit.Category,
                    (in Source source) => source.Core.Outcome.ToString(), (target, value) => target.Outcome = value),
                Column.Create("ResolvedFinalSole", Codecs.Vector, Unit.Metres,
                    (in Source source) => source.Core.FinalSole, (target, value) => target.FinalSole = value),
                Column.Create("ResolvedEffectiveSole", Codecs.Vector, Unit.Metres,
                    (in Source source) => source.Core.EffectiveSole, (target, value) => target.EffectiveSole = value),
                Column.Create("ResolvedGoalTargetAnkle", Codecs.Vector, Unit.Metres,
                    (in Source source) => source.Core.GoalTargetAnkle, (target, value) => target.GoalTargetAnkle = value),
                Column.Create("ResolvedGoalTargetRotation", Codecs.Rotation, Unit.Unitless,
                    (in Source source) => source.Core.GoalTargetRotation, (target, value) => target.GoalTargetRotation = value),
                Column.Create("ResolvedEffectiveAnkle", Codecs.Vector, Unit.Metres,
                    (in Source source) => source.Core.EffectiveAnkle, (target, value) => target.EffectiveAnkle = value),
                Column.Create("ResolvedEffectiveRotation", Codecs.Rotation, Unit.Unitless,
                    (in Source source) => source.Core.EffectiveRotation, (target, value) => target.EffectiveRotation = value),
                Column.Create("ResolvedEffectiveHeel", Codecs.Vector, Unit.Metres,
                    (in Source source) => source.Core.EffectiveHeel, (target, value) => target.EffectiveHeel = value),
                Column.Create("ResolvedEffectiveToe", Codecs.Vector, Unit.Metres,
                    (in Source source) => source.Core.EffectiveToe, (target, value) => target.EffectiveToe = value),
                Column.Create("ResolvedEffectiveSoleFromContacts", Codecs.Vector, Unit.Metres,
                    (in Source source) => source.Core.EffectiveSoleFromContacts, (target, value) => target.EffectiveSoleFromContacts = value),
                Column.Create("ResolvedSourceSoleForward", Codecs.Vector, Unit.Direction,
                    (in Source source) => source.Core.SourceSoleForward, (target, value) => target.SourceSoleForward = value),
                Column.Create("ResolvedSourceSoleFrameLocalRotation", Codecs.Rotation, Unit.Unitless,
                    (in Source source) => source.Core.SourceSoleFrameLocalRotation, (target, value) => target.SourceSoleFrameLocalRotation = value),
                Column.Create("ResolvedGoalTargetCorrection", Codecs.Vector, Unit.Metres,
                    (in Source source) => source.Core.GoalTargetCorrection, (target, value) => target.GoalTargetCorrection = value),
                Column.Create("ResolvedEffectiveSoleCorrection", Codecs.Vector, Unit.Metres,
                    (in Source source) => source.Core.EffectiveSoleCorrection, (target, value) => target.EffectiveSoleCorrection = value),
                Column.Create("ResolvedPositionWeight", Codecs.Float32, Unit.Unitless,
                    (in Source source) => source.Core.PositionWeight, (target, value) => target.PositionWeight = value),
                Column.Create("ResolvedRotationWeight", Codecs.Float32, Unit.Unitless,
                    (in Source source) => source.Core.RotationWeight, (target, value) => target.RotationWeight = value),
            };
            ...
            columns.AddRange(new Column[]
            {
                Column.Create("ResolvedContactAvailable", Codecs.Boolean, Unit.None,
                    (in Source source) => source.Contact.Available, (target, value) => target.ContactAvailable = value),
                Column.Create("ResolvedContactEventIdentity", Codecs.UInt64, Unit.Identity,
                    (in Source source) => source.Contact.EventIdentity, (target, value) => target.ContactEventIdentity = value),
                Column.Create("ResolvedContactPoint", Codecs.Vector, Unit.Metres,
                    (in Source source) => source.Contact.Point, (target, value) => target.ContactPoint = value, "ResolvedContactAvailable"),
                Column.Create("ResolvedContactOwnership", Codecs.Float32, Unit.Unitless,
                    (in Source source) => source.Contact.Ownership, (target, value) => target.ContactOwnership = value),
                Column.Create("ResolvedSupportEligibility", Codecs.Text, Unit.Category,
                    (in Source source) => source.Support.Eligibility.ToString(), (target, value) => target.SupportEligibility = value),
                Column.Create("ResolvedSupportWeight", Codecs.Float32, Unit.Unitless,
                    (in Source source) => source.Support.Weight, (target, value) => target.SupportWeight = value),
                Column.Create("ResolvedSupportIntentWeight", Codecs.Float32, Unit.Unitless,
                    (in Source source) => source.Support.Weight, (target, value) => target.SupportIntentWeight = value),
                Column.Create("ResolvedSupportHorizontalError", Codecs.Float32, Unit.Metres,
                    (in Source source) => source.Support.HorizontalError, (target, value) => target.SupportHorizontalError = value),
                Column.Create("ResolvedSupportEventIdentity", Codecs.UInt64, Unit.Identity,
                    (in Source source) => source.Support.EventIdentity, (target, value) => target.SupportEventIdentity = value),
                Column.Create("ResolvedPelvisReachAvailable", Codecs.Boolean, Unit.None,
                    (in Source source) => source.Reach.PelvisAvailable, (target, value) => target.PelvisReachAvailable = value),
                Column.Create("ResolvedPelvisReachEventIdentity", Codecs.UInt64, Unit.Identity,
                    (in Source source) => source.Reach.PelvisEventIdentity, (target, value) => target.PelvisReachEventIdentity = value),
                Column.Create("ResolvedPelvisReachPoint", Codecs.Vector, Unit.Metres,
                    (in Source source) => source.Reach.PelvisPoint, (target, value) => target.PelvisReachPoint = value, "ResolvedPelvisReachAvailable"),
                Column.Create("ResolvedLandingReachAvailable", Codecs.Boolean, Unit.None,
                    (in Source source) => source.Reach.LandingAvailable, (target, value) => target.LandingReachAvailable = value),
                Column.Create("ResolvedLandingReachEventIdentity", Codecs.UInt64, Unit.Identity,
                    (in Source source) => source.Reach.LandingEventIdentity, (target, value) => target.LandingReachEventIdentity = value),
                Column.Create("ResolvedLandingReachHip", Codecs.Vector, Unit.Metres,
                    (in Source source) => source.Reach.LandingHip, (target, value) => target.LandingReachHip = value, "ResolvedLandingReachAvailable"),
                Column.Create("ResolvedLandingReachTargetAnkle", Codecs.Vector, Unit.Metres,
                    (in Source source) => source.Reach.LandingTargetAnkle, (target, value) => target.LandingReachTargetAnkle = value, "ResolvedLandingReachAvailable"),
                Column.Create("ResolvedLandingReachLegLength", Codecs.Float32, Unit.Metres,
                    (in Source source) => source.Reach.LandingLegLength, (target, value) => target.LandingReachLegLength = value, "ResolvedLandingReachAvailable"),
                Column.Create("ResolvedLandingReachMinimumCompressionReserve", Codecs.Float32, Unit.Metres,
                    (in Source source) => source.Reach.LandingMinimumCompressionReserve, (target, value) => target.LandingReachMinimumCompressionReserve = value, "ResolvedLandingReachAvailable"),
            });
