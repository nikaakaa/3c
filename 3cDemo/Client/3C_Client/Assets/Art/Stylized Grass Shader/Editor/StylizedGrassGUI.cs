...
namespace StylizedGrass
{
    public class StylizedGrassGUI : Editor
    {
        ...
        public static void DrawRenderGraphError()
        {
            ...
            {
                string msg = "Using Render Graph in Unity 6+ is not supported.";
        ...
        public static void DrawUnity6Error()
        {
            #if UNITY_6000_0_OR_NEWER
            
            Color contentColor = GUI.contentColor;
            GUI.contentColor = Color.red * 2f;
            EditorGUILayout.LabelField(
                "Incompatible Unity version, except errors and functionality breaking.\n\n" +
                "An upgrade to the Unity 6 version of this asset is possible at a discount",
                HelpBox);
            ...
            {
                GUILayout.FlexibleSpace();
                if (GUILayout.Button("View on asset store", GUILayout.Width(130), GUILayout.Height(35f)))
                {
                    Application.OpenURL("https://u3d.as/3PK3");
                }
                GUILayout.Space(8);
            }
            GUILayout.Space(11);
