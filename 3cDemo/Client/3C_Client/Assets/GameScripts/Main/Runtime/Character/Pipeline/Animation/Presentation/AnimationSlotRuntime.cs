...
namespace ThirdPersonCharacter.Pipeline.Animation.Presentation
{
    public readonly struct AnimationSlotFramePlan
    {
        public AnimationSlotFramePlan(
            ...
            AnimationPlaybackId markerSourcePlaybackId,
            ActionMarkerRelationId markerRelationId)
        {
            SlotId = slotId;
            ...
            MarkerSourcePlaybackId = markerSourcePlaybackId;
            MarkerRelationId = markerRelationId;
            if (!IsValid)
            {
        ...
        public AnimationPlaybackId MarkerSourcePlaybackId { get; }
        public ActionMarkerRelationId MarkerRelationId { get; }
        public bool TargetsSourcePose => !TargetActionPlaybackId.IsValid;
        public bool HasMarkerSource => MarkerSourcePlaybackId.IsValid;
        public bool HasMarkerRelation => MarkerRelationId.IsValid;
        public bool IsValid =>
            SlotId.IsValid &&
            SlotNodeId.IsValid &&
            ...
            (!HasMarkerSource ||
             ...
             !MarkerSourcePlaybackId.Equals(TargetActionPlaybackId)) &&
            HasMarkerSource == HasMarkerRelation;
    }
    ...
    public sealed class AnimationSlotRuntime
    {
        sealed class SlotState
        {
            ...
            internal AnimationPlaybackId MarkerSource;
            ...
            for (int i = 0; i < SlotCount; i++)
            {
                ...
                if (changed)
                {
                    ...
                    if (state.CurrentAction.IsValid)
                    {
                        ...
                        state.MarkerSource = desired.IsValid
                            ? state.CurrentAction
                            : default;
                    }
                    else
                    {
                        state.MarkerSource = default;
                    }
                ...
                if (state.MarkerSource.IsValid)
                {
                    ...
                    {
                        throw new InvalidOperationException(
                            $"Animation Slot '{state.Descriptor.SlotId}' retained marker source '{state.MarkerSource}' without a live lifecycle entry.");
                    }
                }
                ...
                ActionMarkerRelationId relation =
                    state.MarkerSource.IsValid &&
                    state.CurrentAction.IsValid
                        ? new ActionMarkerRelationId(
                     ...
                     retainedIndex++)
                {
                    ...
                    workspace.AddActionUsage(
                        ...
                        new ActionSlotSourceUsage(
                            state.Descriptor.SlotId,
                            playbackId,
                            playbackId.Equals(state.MarkerSource)
            ...
            AnimationPlaybackId playbackId)
        {
            ...
            if (state.MarkerSource.Equals(playbackId))
                state.MarkerSource = default;
        }
