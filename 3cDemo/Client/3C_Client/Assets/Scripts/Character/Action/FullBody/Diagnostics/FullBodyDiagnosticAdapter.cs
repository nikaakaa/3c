...
namespace ThirdPersonAction
{
    public sealed class FullBodyDiagnosticAdapter
    {
        ...
        public void LogDriverConflict(string targetName, string conflictName)
        {
            Submit(FullBodyDiagnosticEventFormatter.DriverConflict(targetName, conflictName));
        }
    }
    ...
    public static class FullBodyDiagnosticEventFormatter
    {
        ...
        public static CharacterFrameDiagnosticTrace DriverConflict(string targetName, string conflictName)
        {
            return new CharacterFrameDiagnosticTrace(
                RuntimeDiagnosticLogCategory.FullBody,
                RuntimeDiagnosticLogLevel.Error,
                ...
                0,
                Time.frameCount,
                $"FullBodyActionTickAdapter and LocomotionTickAdapter both target {targetName}. Disable one gameplay driver. conflict={conflictName}");
        }
