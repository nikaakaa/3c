...
namespace ThirdPersonCharacter.Pipeline.Animation.Presentation
{
    internal static class ActionPresentationSampleResolver
    {
        internal static ActionAnimationPlaybackFrame Resolve(
            ...
            in ActionMarkerEffectiveSample effective,
            int footPlacementWeightParameterIndex)
        {
            if (workspace == null ||
                ...
                !lifecycle.PlaybackId.Equals(effective.PlaybackId) ||
                projected.ProjectedRawSample.ContinuousTime !=
                effective.ProjectedRawSample.ContinuousTime ||
            ...
            PresentationPoseSampleTime sampleTime = effective.EffectiveSample;
