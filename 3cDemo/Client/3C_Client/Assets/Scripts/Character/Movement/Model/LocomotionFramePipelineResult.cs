...
{
    public readonly struct LocomotionFramePipelineResult
    {
        LocomotionFramePipelineResult(
        ...
        public static LocomotionFramePipelineResult Prepared(
            in LocomotionDecisionFrame decisionFrame,
            in LocomotionFrameRuntimeState runtimeState)
        {
            return new LocomotionFramePipelineResult(
                decisionFrame,
                default,
                default,
                default,
        ...
        public static LocomotionFramePipelineResult Evaluated(
        ...
        public static LocomotionFramePipelineResult Built(
            in LocomotionStateDecisionFrame stateDecision,
