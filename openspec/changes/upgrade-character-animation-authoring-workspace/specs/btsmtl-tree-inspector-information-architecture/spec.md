...
- FROM: `### Requirement: Tree Inspector 必须将 Data 与 Inspector 作为互斥工作页`
- TO: `### Requirement: Tree Workspace必须分离Data与Details区域`
- FROM: `### Requirement: Data 页筛选必须在窄栏中保持 source-aware`
- TO: `### Requirement: Data区域筛选必须在窄栏中保持source-aware`
