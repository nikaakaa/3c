# character-behavior-graph-contracts Specification

## Purpose
定义 CharacterBehaviorGraphDefinition 与 CharacterBehaviorExecutionTree 的 authoring/runtime 合同，约束它们只产出纯数据候选、claim 和 outcome，并继续由 CharacterFramePipeline 仲裁副作用。
## Requirements
