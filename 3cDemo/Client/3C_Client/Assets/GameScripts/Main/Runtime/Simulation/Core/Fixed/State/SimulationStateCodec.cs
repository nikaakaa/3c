...
namespace ThirdPersonSimulation.Fixed
{
    public static class CharacterSimulationStateCodec
    {
        ...
        static void WriteInputRequest(CanonicalWriter writer, FixedInputRequestState value)
        {
        ...
        static FixedInputRequestState ReadInputRequest(CanonicalReader reader)
        {
            if (!reader.ReadBoolean())
                return default;
            var value = new FixedInputRequestState(
                reader.ReadString(),
                reader.ReadUInt64(),
                reader.ReadUInt64(),
                reader.ReadUInt64(),
        ...
        static void WriteActionRequest(CanonicalWriter writer, FixedActionActivationRequestState value)
        {
            writer.WriteBoolean(value.IsValid);
            if (!value.IsValid)
                return;
            ...
            ProgramExecutionLayout layout)
        {
            if (!reader.ReadBoolean())
                return default;
            var value = new FixedActionInstanceState(
                reader.ReadString(),
                reader.ReadString(),
                reader.ReadUInt64(),
                reader.ReadUInt64(),
        ...
        static FixedActionInstanceReference ReadActionReference(CanonicalReader reader)
        {
            if (!reader.ReadBoolean())
                return default;
            var value = new FixedActionInstanceReference(
                reader.ReadString(),
                reader.ReadString(),
                reader.ReadUInt64(),
                reader.ReadUInt64());
