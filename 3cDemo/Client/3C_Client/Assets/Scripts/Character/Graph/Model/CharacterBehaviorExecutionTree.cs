...
namespace ThirdPersonCharacterGraph
{
    ...
    public sealed class CharacterBehaviorExecutionTree
    {
        readonly CharacterExecutionNodeDefinition[] nodes;

        public CharacterBehaviorExecutionTree(
        ...
        public static CharacterBehaviorExecutionTree Empty =>
            new CharacterBehaviorExecutionTree(default, Array.Empty<CharacterExecutionNodeDefinition>());
    }
}
