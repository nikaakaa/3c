...
namespace MCPForUnity.Editor.Services.Transport
{
    ...
    internal static class TransportCommandDispatcher
    {
        ...
        public static Task<string> ExecuteCommandJsonAsync(string commandJson, CancellationToken cancellationToken)
        {
            ...
            if (TryExecuteBackgroundPollingStatus(commandJson, out string statusResponse))
        ...
        private static bool TryExecuteBackgroundPollingStatus(
            string commandJson,
            out string responseJson)
        {
            ...
            try
            {
                ...
                if (command == null ||
                    ...
                    !CommandRegistry.TryExecuteBackgroundPollingStatus(
                        command.type,
            ...
            {
                responseJson = SerializeError(exception.Message);
                return true;
            }
        }
