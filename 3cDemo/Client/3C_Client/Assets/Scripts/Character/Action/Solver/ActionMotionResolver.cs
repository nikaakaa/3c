    ...
    public static class ActionMotionResolver
    {
        public static ActionMotionResolveResult Resolve(in ActionMotionResolveInput input)
        {
            ...
            string diagnosticSummary =
                $"actionMotion={spec.ActionState.Value} variant={spec.Variant} distance={command.PlanarDistance:F3} completed={completed} hasMove={input.HasMoveIntentAtCompletion} runLatch={setRunLatch} sourceStep={spec.SourceStep}";
