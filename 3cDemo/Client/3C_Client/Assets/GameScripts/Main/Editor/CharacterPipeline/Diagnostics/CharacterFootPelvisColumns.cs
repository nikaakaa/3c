            ...
            new CharacterFootCsvGroup<Source, CharacterFootPelvisSample>(
                "Pelvis", () => new CharacterFootPelvisSample(), new Column[]
                {
                    Column.Create("StrideState", Codecs.Text, Unit.Category,
                        (in Source source) => source.Stride.State.ToString(), (target, value) => target.State = value),
                    Column.Create("StrideRejectReason", Codecs.Text, Unit.Category,
                        (in Source source) => source.Stride.RejectReason.ToString(), (target, value) => target.RejectReason = ParseEnumValue<CharacterFootStrideRejectReason>(value, "StrideRejectReason")),
                    Column.Create("StrideSupportSide", Codecs.Text, Unit.Category,
                        (in Source source) => source.Stride.SupportSide.ToString(), (target, value) => target.SupportSide = value),
                    Column.Create("StrideSwingSide", Codecs.Text, Unit.Category,
                        (in Source source) => source.Stride.SwingSide.ToString(), (target, value) => target.SwingSide = value),
                    Column.Create("StrideProgress", Codecs.Float32, Unit.Unitless,
                        (in Source source) => source.Stride.Progress, (target, value) => target.Progress = value),
                    Column.Create("StrideSlope", Codecs.Text, Unit.Category,
                        (in Source source) => source.Stride.Slope.ToString(), (target, value) => target.Slope = ParseEnumValue<CharacterFootStrideSlope>(value, "StrideSlope")),
                    Column.Create("StrideStart", Codecs.Vector, Unit.Metres,
                        (in Source source) => source.Stride.StrideStart, (target, value) => target.Start = value),
                    Column.Create("StrideEnd", Codecs.Vector, Unit.Metres,
                        (in Source source) => source.Stride.StrideEnd, (target, value) => target.End = value),
                    Column.Create("StrideSampledGround", Codecs.Vector, Unit.Metres,
                        (in Source source) => source.Stride.SampledGround, (target, value) => target.SampledGround = value),
                    Column.Create("PelvisPoseInputAvailable", Codecs.Boolean, Unit.None,
                        (in Source source) => source.Stride.PoseInputAvailable, (target, value) => target.Observation.PoseInputAvailable = value),
                    Column.Create("StridePoseRootPosition", Codecs.Vector, Unit.Metres,
                        (in Source source) => source.Stride.PoseRootPosition, (target, value) => target.Observation.PoseRootWorldPosition = value),
                    Column.Create("StrideAnimatedPelvis", Codecs.Vector, Unit.Metres,
                        (in Source source) => source.Stride.AnimatedPelvis, (target, value) => target.Observation.AnimatedWorldPosition = value),
                    Column.Create("StrideAnimatedPelvisComponentPosition", Codecs.Vector, Unit.Metres,
                        (in Source source) => source.Stride.AnimatedPelvisComponentPosition, (target, value) => target.Observation.AnimatedComponentPosition = value),
                    Column.Create("PelvisHeightTargetAvailable", Codecs.Boolean, Unit.None,
                        (in Source source) => source.Stride.HeightTargetAvailable, (target, value) => target.HeightTarget.Available = value),
                    Column.Create("PelvisHeightTargetComponentUp", Codecs.Vector, Unit.Direction,
                        (in Source source) => source.Stride.HeightTargetComponentUp, (target, value) => target.HeightTarget.ComponentUp = value),
                    Column.Create("PelvisHeightTargetLeftAnimatedSole", Codecs.Vector, Unit.Metres,
                        (in Source source) => source.Stride.HeightTargetLeftAnimatedSole, (target, value) => target.HeightTarget.LeftAnimatedSole = value),
                    Column.Create("PelvisHeightTargetRightAnimatedSole", Codecs.Vector, Unit.Metres,
                        (in Source source) => source.Stride.HeightTargetRightAnimatedSole, (target, value) => target.HeightTarget.RightAnimatedSole = value),
                    Column.Create("PelvisHeightTargetLeftTargetSole", Codecs.Vector, Unit.Metres,
                        (in Source source) => source.Stride.HeightTargetLeftTargetSole, (target, value) => target.HeightTarget.LeftTargetSole = value),
                    Column.Create("PelvisHeightTargetRightTargetSole", Codecs.Vector, Unit.Metres,
                        (in Source source) => source.Stride.HeightTargetRightTargetSole, (target, value) => target.HeightTarget.RightTargetSole = value),
                    Column.Create("PelvisHeightTargetAnimatedMinimumAlongUp", Codecs.Float32, Unit.Metres,
                        (in Source source) => source.Stride.HeightTargetAnimatedMinimumAlongUp, (target, value) => target.HeightTarget.AnimatedMinimumAlongUp = value),
                    Column.Create("PelvisHeightTargetMinimumAlongUp", Codecs.Float32, Unit.Metres,
                        (in Source source) => source.Stride.HeightTargetMinimumAlongUp, (target, value) => target.HeightTarget.TargetMinimumAlongUp = value),
                    Column.Create("PelvisRequestedOffsetAlongUp", Codecs.Float32, Unit.Metres,
                        (in Source source) => source.Stride.RequestedOffsetAlongUp, (target, value) => target.HeightTarget.RequestedOffsetAlongUp = value),
                    Column.Create("StrideHadPreviousState", Codecs.Boolean, Unit.None,
                        (in Source source) => source.Stride.HadPreviousState, (target, value) => target.Response.HadPreviousState = value),
                    Column.Create("StrideSupportChanged", Codecs.Boolean, Unit.None,
                        (in Source source) => source.Stride.SupportChanged, (target, value) => target.Response.SupportChanged = value),
                    Column.Create("StridePreviousSlope", Codecs.Text, Unit.Category,
                        (in Source source) => source.Stride.PreviousSlope.ToString(), (target, value) => target.Response.PreviousSlope = ParseEnumValue<CharacterFootStrideSlope>(value, "StridePreviousSlope")),
                    Column.Create("StrideSpringHandoffReason", Codecs.Text, Unit.Category,
                        (in Source source) => source.Stride.SpringHandoffReason.ToString().Replace(", ", "|"), (target, value) => target.Response.Handoff = ParseFlagsValue<CharacterFootPelvisSpringHandoffReason>(value, "StrideSpringHandoffReason", '|')),
                    Column.Create("StrideSpringVelocityReset", Codecs.Boolean, Unit.None,
                        (in Source source) => source.Stride.SpringVelocityReset, (target, value) => target.Response.VelocityReset = value),
                    Column.Create("StridePreviousSpringTarget", Codecs.Float32, Unit.Metres,
                        (in Source source) => source.Stride.PreviousSpringTarget, (target, value) => target.Response.PreviousTarget = value),
                    Column.Create("StridePreviousSpringOutput", Codecs.Float32, Unit.Metres,
                        (in Source source) => source.Stride.PreviousSpringOutput, (target, value) => target.Response.PreviousOutput = value),
                    Column.Create("StridePreviousSpringVelocity", Codecs.Float32, Unit.MetresPerSecond,
                        (in Source source) => source.Stride.PreviousSpringVelocity, (target, value) => target.Response.PreviousVelocity = value),
                    Column.Create("StrideSpringInput", Codecs.Float32, Unit.Metres,
                        (in Source source) => source.Stride.SpringInput, (target, value) => target.Response.Input = value),
                    Column.Create("StrideSpringInputVelocity", Codecs.Float32, Unit.MetresPerSecond,
                        (in Source source) => source.Stride.SpringInputVelocity, (target, value) => target.Response.InputVelocity = value),
                    Column.Create("StrideSpringFrequency", Codecs.Float32, Unit.Hertz,
                        (in Source source) => source.Stride.SpringFrequency, (target, value) => target.Response.Frequency = value),
                    Column.Create("PelvisPosturePreferenceEvaluated", Codecs.Boolean, Unit.None,
                        (in Source source) => source.Stride.PosturePreferenceEvaluated, (target, value) => target.Posture.Evaluated = value),
                    Column.Create("PelvisPosturePreferenceAvailable", Codecs.Boolean, Unit.None,
                        (in Source source) => source.Stride.PosturePreferenceAvailable, (target, value) => target.Posture.Available = value),
                    Column.Create("PelvisPosturePreferenceHip", Codecs.Vector, Unit.Metres,
                        (in Source source) => source.Stride.PosturePreferenceHip, (target, value) => target.Posture.Hip = value),
                    Column.Create("PelvisPosturePreferenceAnimatedAnkle", Codecs.Vector, Unit.Metres,
                        (in Source source) => source.Stride.PosturePreferenceAnimatedAnkle, (target, value) => target.Posture.AnimatedAnkle = value),
                    Column.Create("PelvisPosturePreferenceTargetAnkle", Codecs.Vector, Unit.Metres,
                        (in Source source) => source.Stride.PosturePreferenceTargetAnkle, (target, value) => target.Posture.TargetAnkle = value),
                    Column.Create("PelvisPosturePreferenceLegLength", Codecs.Float32, Unit.Metres,
                        (in Source source) => source.Stride.PosturePreferenceLegLength, (target, value) => target.Posture.LegLength = value),
                    Column.Create("PelvisPosturePreferenceCompressionReserve", Codecs.Float32, Unit.Metres,
                        (in Source source) => source.Stride.PosturePreferenceCompressionReserve, (target, value) => target.Posture.CompressionReserve = value),
                    Column.Create("PelvisPosturePreferenceUsableLegLength", Codecs.Float32, Unit.Metres,
                        (in Source source) => source.Stride.PosturePreferenceUsableLegLength, (target, value) => target.Posture.UsableLegLength = value),
                    Column.Create("PelvisPosturePreferenceMinimumAlongUp", Codecs.Float32, Unit.Metres,
                        (in Source source) => source.Stride.PosturePreferenceMinimumAlongUp, (target, value) => target.Posture.MinimumAlongUp = value),
                    Column.Create("PelvisPosturePreferenceMaximumAlongUp", Codecs.Float32, Unit.Metres,
                        (in Source source) => source.Stride.PosturePreferenceMaximumAlongUp, (target, value) => target.Posture.MaximumAlongUp = value),
                    Column.Create("PelvisPosturePreferenceOffsetAlongUp", Codecs.Float32, Unit.Metres,
                        (in Source source) => source.Stride.PosturePreferenceOffsetAlongUp, (target, value) => target.Posture.OffsetAlongUp = value),
                    Column.Create("PelvisPosturePreferenceTargetAdjusted", Codecs.Boolean, Unit.None,
                        (in Source source) => source.Stride.PosturePreferenceTargetAdjusted, (target, value) => target.Posture.TargetAdjusted = value),
                    ...
                    Column.Create("PelvisResponseEvaluated", Codecs.Boolean, Unit.None,
                        (in Source source) => source.Stride.ResponseEvaluated, (target, value) => target.Response.Evaluated = value),
                    Column.Create("PelvisSpringCompleted", Codecs.Boolean, Unit.None,
                        (in Source source) => source.Stride.SpringCompleted, (target, value) => target.Response.Completed = value),
                    Column.Create("PelvisSpringIntegratedOutput", Codecs.Float32, Unit.Metres,
                        (in Source source) => source.Stride.SpringIntegratedOutput, (target, value) => target.Response.IntegratedOutput = value),
                    Column.Create("StrideSpringTarget", Codecs.Float32, Unit.Metres,
                        (in Source source) => source.Stride.SpringTarget, (target, value) => target.Response.Target = value),
                    Column.Create("StrideSpringOutput", Codecs.Float32, Unit.Metres,
                        (in Source source) => source.Stride.SpringOutput, (target, value) => target.Response.Output = value),
                    Column.Create("StrideSpringVelocity", Codecs.Float32, Unit.MetresPerSecond,
                        (in Source source) => source.Stride.SpringVelocity, (target, value) => target.Response.Velocity = value),
                    Column.Create("StridePelvisDelta", Codecs.Vector, Unit.Metres,
                        (in Source source) => source.Stride.PelvisDelta, (target, value) => target.Delta = value),
                    Column.Create("StridePositionWeight", Codecs.Float32, Unit.Unitless,
                        (in Source source) => source.Stride.PositionWeight, (target, value) => target.Response.PositionWeight = value),
