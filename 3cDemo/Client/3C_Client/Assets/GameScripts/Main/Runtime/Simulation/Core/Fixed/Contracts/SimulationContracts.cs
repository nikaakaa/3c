...
namespace ThirdPersonSimulation.Fixed
{
    ...
    public readonly struct SimulationInputValue
    {
        ...
        public static SimulationInputValue FromScalar(string inputId, FixedScalar value) => new SimulationInputValue(inputId, SimulationInputValueKind.Scalar, default, value, default, default, default, default);
        public static SimulationInputValue FromVector2(string inputId, FixedVector2 value) => new SimulationInputValue(inputId, SimulationInputValueKind.Vector2, default, default, value, default, default, default);
        public static SimulationInputValue FromVector3(string inputId, FixedVector3 value) => new SimulationInputValue(inputId, SimulationInputValueKind.Vector3, default, default, default, value, default, default);
        public static SimulationInputValue FromYaw(string inputId, FixedYaw value) => new SimulationInputValue(inputId, SimulationInputValueKind.Yaw, default, default, default, default, value, default);
    ...
    {
        public GameplayFact(SimulationEventHeader header, GameplayFactKind kind, string subjectId, string stateId, FixedScalar scalar)
        {
    ...
    public readonly struct PresentationCommand
    {
        ...
        public FixedScalar SampleTime { get; }
