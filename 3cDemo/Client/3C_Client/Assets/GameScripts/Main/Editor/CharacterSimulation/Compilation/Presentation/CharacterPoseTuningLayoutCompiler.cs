...
namespace ThirdPersonCharacter.Pipeline.Simulation.Editor
{
    ...
    internal static class CharacterPoseTuningLayoutCompiler
    {
            ...
            List<FieldValue> fields)
        {
            ...
            AddFloat(fields, ownerId, $"{ownerId}/lyra-current-grounding/pelvis-offset-target-velocity-amount", "Pelvis Offset Target Velocity", grounding.PelvisOffsetTargetVelocityAmount, 0f, 1f, "normalized", ownerId, CharacterPoseTuningApplyTiming.NextFrame, CharacterPoseTuningStatePolicy.PreserveState, ref nextFloat);
            ...
            AddFloat(fields, ownerId, $"{ownerId}/stance-stabilization/minimum-leg-extension-ratio", "Minimum Leg Extension", stance.MinimumLegExtensionRatio, 0.01f, 0.9f, "ratio", ownerId, CharacterPoseTuningApplyTiming.NextFrame, CharacterPoseTuningStatePolicy.PreserveState, ref nextFloat);
            AddFloat(fields, ownerId, $"{ownerId}/stance-stabilization/maximum-leg-extension-ratio", "Maximum Leg Extension", stance.MaximumLegExtensionRatio, 0.5f, 0.999f, "ratio", ownerId, CharacterPoseTuningApplyTiming.NextFrame, CharacterPoseTuningStatePolicy.PreserveState, ref nextFloat);
