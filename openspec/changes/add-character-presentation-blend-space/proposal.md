...
- BlendSpacePlayer、BlendStack、MarkerSync、Inertialization、`Lyra Current Grounding -> Stance Stabilization -> Pelvis Resolve` FootGrounding、可选Swing脚Predictive Modifier与FullBodyIK各自只有一项清晰职责，代码链中没有第二个权重、过渡、同步、Grounding或IK权威。
