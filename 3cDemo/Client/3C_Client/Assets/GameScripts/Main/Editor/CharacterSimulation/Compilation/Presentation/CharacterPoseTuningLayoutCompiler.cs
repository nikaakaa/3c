...
namespace ThirdPersonCharacter.Pipeline.Simulation.Editor
{
    ...
    internal static class CharacterPoseTuningLayoutCompiler
    {
            ...
            List<FieldValue> fields)
        {
            ...
            AddFloat(fields, ownerId, $"{ownerId}/predictive/plant-distance", "Plant Distance", predictive.PlantDistance, 0f, 10f, "meters", ownerId, CharacterPoseTuningApplyTiming.NextFrame, CharacterPoseTuningStatePolicy.PreserveState, ref nextFloat);
            AddFloat(fields, ownerId, $"{ownerId}/predictive/release-distance", "Release Distance", predictive.ReleaseDistance, 0f, 10f, "meters", ownerId, CharacterPoseTuningApplyTiming.NextFrame, CharacterPoseTuningStatePolicy.PreserveState, ref nextFloat);
            AddFloat(fields, ownerId, $"{ownerId}/predictive/plant-planar-speed", "Plant Planar Speed", predictive.PlantPlanarSpeed, 0f, 10f, "meters/second", ownerId, CharacterPoseTuningApplyTiming.NextFrame, CharacterPoseTuningStatePolicy.PreserveState, ref nextFloat);
            AddFloat(fields, ownerId, $"{ownerId}/predictive/release-planar-speed", "Release Planar Speed", predictive.ReleasePlanarSpeed, 0f, 10f, "meters/second", ownerId, CharacterPoseTuningApplyTiming.NextFrame, CharacterPoseTuningStatePolicy.PreserveState, ref nextFloat);
            AddFloat(fields, ownerId, $"{ownerId}/predictive/plant-vertical-speed", "Plant Vertical Speed", predictive.PlantVerticalSpeed, 0f, 10f, "meters/second", ownerId, CharacterPoseTuningApplyTiming.NextFrame, CharacterPoseTuningStatePolicy.PreserveState, ref nextFloat);
            AddFloat(fields, ownerId, $"{ownerId}/predictive/release-vertical-speed", "Release Vertical Speed", predictive.ReleaseVerticalSpeed, 0f, 10f, "meters/second", ownerId, CharacterPoseTuningApplyTiming.NextFrame, CharacterPoseTuningStatePolicy.PreserveState, ref nextFloat);
            AddFloat(fields, ownerId, $"{ownerId}/predictive/descending-tolerance", "Descending Tolerance", predictive.DescendingTolerance, 0f, 10f, "meters/second", ownerId, CharacterPoseTuningApplyTiming.NextFrame, CharacterPoseTuningStatePolicy.PreserveState, ref nextFloat);
