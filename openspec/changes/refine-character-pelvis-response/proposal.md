...
3. 按用户最新决定删除全部骨盆Reach硬夹紧和末端Foot径向夹脚。真实腿长及正式余量保留逐腿／交集观察和原Landing完成资格；共同目标、软姿态偏好、唯一Spring、脚目标与权重保持。
...
第16步正式撤除第15步保留的Primary硬执行例外，不在回放后擅自恢复。现行spec要求typed可达冲突事实，本步继续发布事实，但明确不再以业务层硬挪骨盆／夹脚处理；真实IK误差保留，不宣称最终骨盆被锁定或所有目标必然可达。旧硬安全保证随执行路径撤销。
