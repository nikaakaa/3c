...
namespace ThirdPersonCharacter.Pipeline.Animation
{
    ...
    [Serializable]
    public readonly struct AnimationPhaseCoverage
    {
        ...
        [field: SerializeField] public float StartSeconds { get; }
        [field: SerializeField] public float EndSeconds { get; }
    ...
    [Serializable]
    public readonly struct AnimationPhaseKnot
    {
        ...
        [field: SerializeField] public float TimeSeconds { get; }
        [field: SerializeField] public float UnwrappedPhase { get; }
    }
