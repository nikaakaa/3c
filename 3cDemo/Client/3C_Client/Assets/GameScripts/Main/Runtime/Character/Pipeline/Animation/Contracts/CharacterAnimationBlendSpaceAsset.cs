...
namespace ThirdPersonCharacter.Pipeline.Animation
{
    ...
    public sealed class CharacterAnimationBlendSpaceAsset : ScriptableObject
    {
        ...
        {
            m_Samples = samples == null ? Array.Empty<CharacterAnimationBlendSpaceSample>() : (CharacterAnimationBlendSpaceSample[])samples.Clone();
            if (PhaseReferenceSampleId.IsValid && FindSample(PhaseReferenceSampleId) == null)
            {
                m_PhaseReferenceSampleId = string.Empty;
                m_PhasePolicy = CharacterAnimationBlendSpacePhasePolicy.SharedNormalizedPhase;
            }
            TouchContentRevision();
        }
